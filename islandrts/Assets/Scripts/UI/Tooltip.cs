...
/// first so buttons on the row still win the raycast. Never built under the sim.
/// </remarks>
public class Tooltip : MonoBehaviour
{
    ...
    public static void Attach(RectTransform target, string text)
    {
        ...
        EventTrigger trigger = surface.gameObject.AddComponent<EventTrigger>();
        EventTrigger.Entry enter = new EventTrigger.Entry { eventID = EventTriggerType.PointerEnter };
        enter.callback.AddListener(_ => instance.Enter(surface, text));
        trigger.triggers.Add(enter);
        EventTrigger.Entry exit = new EventTrigger.Entry { eventID = EventTriggerType.PointerExit };
        exit.callback.AddListener(_ => instance.Exit(surface));
        trigger.triggers.Add(exit);
        EventTrigger.Entry down = new EventTrigger.Entry { eventID = EventTriggerType.PointerDown };
        down.callback.AddListener(_ => instance.Exit(surface));
