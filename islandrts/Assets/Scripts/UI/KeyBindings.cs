...
public static class KeyBindings
{
    public enum Action
    {
        ...
        BuildMode,
        SelectHut, SelectWoodWall, SelectStoneWall, SelectWatchtower, SelectWorkshop, SelectShipyard, SelectStorehouse,
    ...
    private static readonly Dictionary<Action, Binding> Defaults = new Dictionary<Action, Binding>
    {
        ...
        { Action.SelectShipyard,     new Binding(KeyCode.Alpha6, KeyCode.Keypad6) },
