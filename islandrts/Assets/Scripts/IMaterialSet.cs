...
/// renderers, so a second system can tint or cut the object without collecting a
...
/// actually drawing with wins — which is how a hover highlight and a cutout can both
/// look "sometimes broken". The rule is one collector per object; this interface is how
/// the second system finds it.
///
/// <see cref="OccluderCutout"/> asks for this before falling back to collecting its own,
