...
Branch `feature/balance-sim-and-menus`; everything through the Setup Everything re-serialization + Stone Pile art (e537008) is committed. Uncommitted: the occluder cutout (section H).
