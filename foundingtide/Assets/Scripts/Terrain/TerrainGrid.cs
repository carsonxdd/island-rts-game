...
public class TerrainGrid : MonoBehaviour
{
    ...
    [Header("Materials (wired by Tools > Founding Tide > Terrain setup)")]
    ...
    Material[] ResolveMaterials()
    {
        ...
        if (missing)
        {
            Debug.LogError("TerrainGrid: surfaceMaterials incomplete (" + SurfaceCount + " expected, one per Surface). "
                + "Run Tools > Founding Tide > Terrain > Setup Terrain Scene.");
        }
    ...
    void CreateWaterPlane()
    {
        ...
        {
            Debug.LogError("TerrainGrid: waterMaterial not assigned — no water plane. Run Tools > Founding Tide > Terrain > Setup Terrain Scene.");
            return;
        }
