...
public class PauseController : MonoBehaviour
{
    ...
    private static bool ModeActive()
    {
        ...
        // The selected-building card (2026-09-18): Esc dismisses the card before it
        // reaches the pause menu, the same deal the campfire panel has.
        if (SelectedBuildingHUD.IsOpen)
        {
            SelectedBuildingHUD.Close();
            return true;
        }
