...
/// </remarks>
public class Gate : MonoBehaviour, ITargetable, IBuildingIdentity
{
    public BuildingType BuildingType => isStoneGate ? BuildingType.StoneGate : BuildingType.WoodenGate;
