...
public class GameStartController : MonoBehaviour
{
    ...
    void EnterPlacement()
    {
        ...
        {
            Debug.LogError("GameStartController: campfireGhostPrefab not assigned! Run Tools > Founding Tide > Opening Sequence > Setup Opening Scene.");
            return;
        }
    ...
    void UpdatePlacing()
    {
        ...
        if (Input.GetMouseButtonDown(0) && ghostValid && !PointerBlock.OverHud)
        {
            ConfirmPlacement();
        }
    }
    ...
    void SpawnCampfire(Vector3 position)
    {
        ...
        {
            Debug.LogError("GameStartController: campfirePrefab not assigned! Run Tools > Founding Tide > Opening Sequence > Setup Opening Scene.");
            return;
        }
    ...
    void SpawnPlayerAt(Vector3 spawnPos, Quaternion rotation)
    {
        ...
        {
            Debug.LogError("GameStartController: playerPrefab not assigned! Run Tools > Founding Tide > Opening Sequence > Setup Opening Scene.");
            return;
        }
