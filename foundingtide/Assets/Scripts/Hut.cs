...
/// <summary>
/// Player-built housing, ANY TIER. Each one adds worker slots to the colony's population
/// cap and is a target enemies will chew through on their way to the campfire.
/// </summary>
/// <remarks>
/// The class is named for the tier that came first, but since 2026-09-18 it is the housing
/// component for the Tent as well: every consumer - Population, the raider target order,
/// Prosperity, Siege, the minimap - wants "any housing", which is exactly what
/// Hut.ActiveList already means. The tiers differ only in serialized values (capacity,
/// health) and in <see cref="buildingType"/>, which is what keeps a Tent from refunding,
/// repairing or upgrading at Hut prices.
///
...
/// </remarks>
public class Hut : MonoBehaviour, ITargetable, IHousing, IBuildingIdentity
{
    [Header("Identity")]
    [Tooltip("Which tier this prefab is. Tent.prefab says Tent, Hut.prefab says Hut.")]
    public BuildingType buildingType = BuildingType.Hut;
