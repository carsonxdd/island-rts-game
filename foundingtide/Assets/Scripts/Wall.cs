...
/// </remarks>
public class Wall : MonoBehaviour, ITargetable, IBuildingIdentity
{
    public BuildingType BuildingType => isStoneWall ? BuildingType.StoneWall : BuildingType.WoodenWall;
