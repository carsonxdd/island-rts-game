...
3. Right-click the fire to deposit what you carry, then use the panel's **Craft** tab: a Stone Axe (2 sticks, 1 stone) teaches the colony to cut wood, a Fishing Spear to forage, a Mallet to build, a Wooden Spear to fight. Survivors come ashore by day while there is free housing — the campfire houses 3 — and the Colonists tab hands them the jobs you have unlocked
...
5. Watch the calendar chip on the HUD. The first two nights are always quiet; from day 3 a dawn may turn it red — "Raid tonight · N raiders" — and that is your day to recruit 2-3 warriors (each one is an idle colonist taking up arms)
...
│   ├── Items/                   # ItemCatalog, Inventory, CraftingCatalog, Unlocks, HeldItem
...
| **Crafting** | At the campfire (Craft tab): six tools made from sticks, stones and a little wood or stone while your character stands at the fire. Each first craft is knowledge for the whole colony — Stone Axe / Fishing Spear / Stone Pick / Metal Pick unlock the four jobs, the Mallet unlocks build mode and builders, the Wooden Spear unlocks warriors. Every locked control names the recipe that opens it. The Workshop keeps its one-time upgrades: Sharpened Tools (+30% gather), Sturdy Scaffolds (+50% build speed), Forged Blades (+30% warrior damage). |
