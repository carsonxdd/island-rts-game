...
| **Fog of war** | The island starts dark and clears for good as your people and buildings see it; ground nobody is watching sits in a grey shroud. Raiders show only while something of yours can see them, so a raid can be an ambush and the Watchtower's long sight is its second job. Colonists only fetch pickups on explored ground. Gathering and placement gates and a minimap are still to come. |
